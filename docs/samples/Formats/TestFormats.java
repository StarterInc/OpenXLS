	...
	*/
	...
	void testBorders(String finpath, String sheetname){
		...
		try{
			...
			io.starter.OpenXLS.util.Logger.log(i);
	...
	void testFormats(String finpath, String sheetname){    
		...
		try{
			...
			cell1.setVal(555);     
			io.starter.OpenXLS.util.Logger.log("CELL FCOLOR: " + cell1.getForegroundColor());
			io.starter.OpenXLS.util.Logger.log("CELL FCOLOR: " + cell1.getBackgroundColor());
		}catch(Exception e){io.starter.OpenXLS.util.Logger.log(e);}
