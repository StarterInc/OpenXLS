	...
	*/
	public void test(){
		...
		for(int i = 0;i<testfiles.length;i++){
			finpath = testfiles[i];
			io.starter.OpenXLS.util.Logger.log("====================== TEST: " + String.valueOf(i) + " ======================");
			sheetname = testfiles[++i];
			io.starter.OpenXLS.util.Logger.log("=====================> " + finpath + ":" + sheetname);
	...
	void doit(String finpath, String sheetname){    
		io.starter.OpenXLS.util.Logger.log("Begin parsing: " + workingdir + finpath);
		...
		try{
			...
			for(int t=0;t<extracted.length;t++) {
				io.starter.OpenXLS.util.Logger.log("Successfully extracted: " + workingdir + "testImageOut_" + extracted[t].getName()+"."+extracted[t].getType());
		...
		io.starter.OpenXLS.util.Logger.log("Successfully read: " + newbook);
	}
