...
class testformula{
	...
	public void testCalculation(){
		...
		}catch(CellNotFoundException e){io.starter.OpenXLS.util.Logger.log("cell not found" + e);
		}catch(FormulaNotFoundException e){io.starter.OpenXLS.util.Logger.log("No formula to change" + e);
		}catch(Exception e){
    ...
    public void testFormula(){
        ...
        }catch(Exception e){io.starter.OpenXLS.util.Logger.log("Exception in testFORMULA.testFormulaSeries(): " + e);}
    }
