...
//      IMPORTANT PERFORMANCE SETTINGS!!!
        ...
        io.starter.OpenXLS.util.Logger.log("Beginning Cell Adds");
        String addr = "";
        ...
        try{
            ...
            io.starter.OpenXLS.util.Logger.log(cellA3.getStringVal());
	    ...
	    io.starter.OpenXLS.util.Logger.log(" Double values took: " + ((System.currentTimeMillis() - ltimr)) + " milliseconds.");
        ...
        System.out.print("Adding " + NUMADDS);
	    io.starter.OpenXLS.util.Logger.log(" Strings took: " + ((System.currentTimeMillis() - ltimr)) + " milliseconds.");

	    ltimr = System.currentTimeMillis();
	    this.testWrite(book);
        io.starter.OpenXLS.util.Logger.log("Done.");
        System.out.print("Writing " + book);
	    io.starter.OpenXLS.util.Logger.log(" took: " + ((System.currentTimeMillis() - ltimr)) + " milliseconds.");
