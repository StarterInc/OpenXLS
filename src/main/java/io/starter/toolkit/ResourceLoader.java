...
public class ResourceLoader extends InitialContextImpl implements Serializable, javax.naming.Context{
    ...
    */
     ...
     */
    public static byte[] getBytesFromJar (String name)
    throws IOException {
	...
	public static String getWorkingDirectoryFromJar(String resource){
		String s;
			...
			if(i > -1){
				...
				if (i == -1){i = zipstring.lastIndexOf("\\");}
	...
	public static String Decode(String s, String encoding){
		 ...
		 * @return the return value of the method if any
		 */
		public static Object execute(Object ob, Object[] args, String methname)
		throws Exception{
