...
extends java.lang.Thread implements Map, io.starter.toolkit.RecycleBin     
{
    ...
    /** add an item
    */
    public void addItem(Recyclable r)
    ...
    public void addItem(Object key, Recyclable r)
    throws RecycleBinFullException
     {
        // recycle();
        if((MAXITEMS == -1) || (map.size() < MAXITEMS)){
    ...
    */
     ...
     */
    public synchronized Recyclable getItem()
    throws RecycleBinFullException{
