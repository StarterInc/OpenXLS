...
class NameImpl : Name {
    ...
    override fun getAll(): Enumeration<String>? {
        return values.elements() as Enumeration<String>
    }
    ...
    override fun addAll(arg0: Int, arg1: Name): Name {
        values.addAll(arg0, (arg1 as NameImpl).getVals())
        return this
    }
    ...
    override fun addAll(arg0: Name): Name {
        values.addAll((arg0 as NameImpl).getVals())
        return this
    }
    ...
    override fun endsWith(arg0: Name): Boolean {
        val ob1: Any = arg0[arg0.size() - 1]
        val ob2: Any = this[size() - 1]
        return ob1 == ob2
    }
     ...
     * @param vector
     */
    fun setVals(vector: CompatibleVector) {
        values = vector
    }
    ...
    companion object {
         ...
         * serialVersionUID
         */
        private const val serialVersionUID = 4387233472850688497L
    }
}