...
public class InitialContextImpl implements javax.naming.Context{
	...
	public static String CONTEXT_ID = "io.starter.naming.InitialContextImpl_instance";
	public static String LOAD_CONTEXT = "io.starter.naming.load_context";
  ...
  public void unbind(String name) throws NamingException
  {
	  ...
	  }catch(Exception e){throw new NamingException(e.toString());}
  }
