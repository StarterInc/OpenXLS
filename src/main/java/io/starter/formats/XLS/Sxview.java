...
/*        SxDI sxdi= (SxDI) getSubRec(SXDI, -1);
    ...
    private void initGrbit() {
        fRwGrand = (grbit1 & 0x1) == 0x1;
        fColGrand = (grbit1 & 0x2) == 0x2;
        fAutoFormat = (grbit1 & 0x8) == 0x8;
        fWH = (grbit1 & 0x10) == 0x10;
        fFont = (grbit1 & 0x20) == 0x20;
        fAlign = (grbit1 & 0x40) == 0x40;
        fBorder = (grbit1 & 0x80) == 0x80;
        fPattern = (grbit2 & 0x1) == 0x1;
        fNumber = (grbit2 & 0x2) == 0x2;
