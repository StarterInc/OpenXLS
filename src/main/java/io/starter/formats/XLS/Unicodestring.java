    ...
    public boolean equals(Object obj) {
        if (obj instanceof Unicodestring) {
            ...
            if (this.westernencoding) {
                return java.util.Arrays.equals(this.getWesternBytes(), ((Unicodestring) obj).getWesternBytes());
            } else {
                return java.util.Arrays.equals(this.getEasternBytes(), ((Unicodestring) obj).getEasternBytes());
            }
