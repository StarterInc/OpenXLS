...
//		expression = shared.instantiate( pointer );
    ...
    public void updateRecord() {
        ...
        if (cachedValue instanceof String && !"".equals(cachedValue) && !isErrorValue((String) cachedValue)) {// if it's a string and not an error string
...
/*		if (expression.get(0) instanceof PtgExp) {
     ...
     * recalc
     *
     * @see io.starter.formats.XLS.XLSRecord#setCachedValue(java.lang.Object)
     */
