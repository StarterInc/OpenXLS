...
public final class Externsheet extends io.starter.formats.XLS.XLSRecord 
{
    /** 
	* serialVersionUID
	*/
     ...
     */
     public int getcXTI(){return cXTI;}
...
//            x.addSheet(sheetNum1, sheetNum2);       
    ...
    public  int getXtiReference(String firstSheet, String secondSheet) {
        for (int i=0;i<rgs.size();i++) {
            ...
            try {
                ...
                if(DEBUGLEVEL > 10)Logger.logWarn("Externsheet.getXtiReference:  Attempt to find Externsheet reference for sheet failed: " + we);
            }
        }
        return -1;
    }
    ...
    class rgxti implements java.io.Serializable{
		...
		*/
         ...
         * (therefore sheet references are not found in the current workbook)
         */ 
        public boolean getIsExternal() { return this.bIsExternal; }
