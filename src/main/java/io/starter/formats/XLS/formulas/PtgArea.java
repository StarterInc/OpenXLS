...
//      FIX broken COLROW
    ...
    public boolean contains(int[] rc) {
        ...
        if(rc[1] < thisRange[1])return false; // col before the first ref col?
        if(rc[1] > thisRange[3])return false; // col after the last ref col?
    ...
    */
	...
	public void setLocation(String[] loc) {
    	...
    	if(firstPtg==null){
			...
			if(this.getParentRec()!=null)this.populateVals();
