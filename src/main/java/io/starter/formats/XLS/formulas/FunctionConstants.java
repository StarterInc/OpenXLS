 ...
 */	
	...
	****************************************/
    ...
    public static String getJFunctionString(short iftb) {
        switch(iftb) {
            case xlfDollar: return "YEN(";
            case xlfUsdollar: return "DOLLAR(";
            case xlfDbcs: return "JIS(";
        }
        return null;
    }
    ...
    public static String getFunctionString(short iftb){
        switch(iftb){
        	case xlfADDIN: return "";
			case XLF_COUNT: return "COUNT(";
			case XLF_IS: return "IF(";
			case XLF_IS_NA: return "ISNA(";
			case XLF_IS_ERROR: return "ISERROR(";
			case XLF_SUM: return "SUM(";
			case XLF_AVERAGE: return "AVERAGE(";
			case XLF_MIN: return "MIN(";
			case XLF_MAX: return "MAX(";
			case XLF_ROW: return "ROW(";
			case xlfColumn: return "COLUMN(";
			case xlfNa: return "NA(";
			case xlfNpv: return "NPV(";
			case xlfStdev: return "STDEV(";
			case xlfDollar: return "DOLLAR(";
			case xlfFixed: return "FIXED(";
			case xlfSin: return "SIN(";
			case xlfCos: return "COS(";
			case xlfTan: return "TAN(";
			case xlfAtan: return "ATAN(";
			case xlfPi: return "PI(";
			case xlfSqrt: return "SQRT(";
			case xlfExp: return "EXP(";
			case xlfLn: return "LN(";
			case xlfLog10: return "LOG10(";
			case xlfAbs: return "ABS(";
			case xlfInt: return "INT(";
			case xlfSign: return "SIGN(";
			case xlfRound: return "ROUND("; 
			case xlfLookup: return "LOOKUP(";
			case xlfIndex: return "INDEX(";
			case xlfRept: return "REPT(";
			case xlfMid: return "MID(";
			case xlfLen: return "LEN(";
			case xlfValue: return "VALUE(";
			case xlfTrue: return "TRUE(";
			case xlfFalse: return "FALSE(";
			case xlfAnd: return "AND(";
			case xlfOr: return "OR(";
			case xlfNot: return "NOT(";
			case xlfMod: return "MOD(";
			case xlfDaverage: return "DAVERAGE(";
  			case xlfDcount: return "DCOUNT(";
			case xlfDcounta: return "DCOUNTA(";
			case xlfDget: return "DGET(";
			case xlfDmax: return "DMAX(";
			case xlfDmin: return "DMIN(";
			case xlfDproduct: return "DPRODUCT(";
			case xlfDstdev: return "DSTDEV(";
			case xlfDstdevp: return "DSTDEVP(";
			case xlfDsum: return "DSUM(";
			case xlfDvar: return "DVAR(";
			case xlfDvarp: return "DVARP(";
			case xlfVar: return "VAR(";
			case xlfText: return "TEXT(";
			case xlfLinest: return "LINEST(";
			case xlfTrend: return "TREND(";
			case xlfLogest: return "LOGEST(";
			case xlfGrowth: return "GROWTH(";
			case xlfGoto: return "GOTO(";
			case xlfHalt: return "HALT(";
			case xlfPv: return "PV(";
			case xlfFv: return "FV(";
			case xlfNper: return "NPER(";
			case xlfPmt: return "PMT(";
			case xlfRate: return "RATE(";
			case xlfMirr: return "MIRR(";
			case xlfIrr: return "IRR(";
			case xlfRand: return "RAND(";
			case xlfMatch: return "MATCH(";
			case xlfDate: return "DATE(";
			case xlfTime: return "TIME(";
			case xlfDay: return "DAY(";
			case xlfMonth: return "MONTH(";
			case xlfYear: return "YEAR(";
			case xlfWeekday: return "WEEKDAY(";
			case xlfHour: return "HOUR(";
			case xlfMinute: return "MINUTE(";
			case xlfSecond: return "SECOND(";
			case xlfNow: return "NOW(";
			case xlfAreas: return "AREAS(";
			case xlfRows: return "ROWS(";
			case xlfColumns: return "COLUMNS(";
			case xlfOffset: return "OFFSET(";
			case xlfAbsref: return "ABSREF(";
			case xlfRelref: return "RELREF(";
			case xlfArgument: return "ARGUMENT(";
			case xlfSearch: return "SEARCH(";
			case xlfTranspose: return "TRANSPOSE(";
			case xlfError: return "ERROR(";
			case xlfStep: return "STEP(";
			case xlfType: return "TYPE(";
			case xlfEcho: return "ECHO(";
			case xlfSetName: return "SETNAME(";
			case xlfCaller: return "CALLER(";
			case xlfDeref: return "DEREF(";
			case xlfWindows: return "WINDOWS(";
			case xlfSeries: return "SERIES(";
			case xlfDocuments: return "DOCUMENTS(";
			case xlfActiveCell: return "ACTIVECELL(";
			case xlfSelection: return "SELECTION(";
			case xlfResult: return "RESULT(";
			case xlfAtan2: return "ATAN2(";
			case xlfAsin: return "ASIN(";
			case xlfAcos: return "ACOS(";
			case xlfChoose: return "CHOOSE(";
			case xlfHlookup: return "HLOOKUP(";
			case xlfVlookup: return "VLOOKUP(";
			case xlfLinks: return "LINKS(";
			case xlfInput: return "INPUT(";
			case xlfIsref: return "ISREF(";
			case xlfGetFormula: return "GETFORMULA(";
			case xlfGetName: return "GETNAME(";
			case xlfSetValue: return "SETVALUE(";
			case xlfLog: return "LOG(";
			case xlfExec: return "EXEC(";
			case xlfChar: return "CHAR(";
			case xlfLower: return "LOWER(";
			case xlfUpper: return "UPPER(";
			case xlfProper: return "PROPER(";
			case xlfLeft: return "LEFT(";
			case xlfRight: return "RIGHT(";
			case xlfExact: return "EXACT(";
			case xlfTrim: return "TRIM(";
			case xlfReplace: return "REPLACE(";
			case xlfSubstitute: return "SUBSTITUTE(";
			case xlfCode: return "CODE(";
			case xlfNames: return "NAMES(";
			case xlfDirectory: return "DIRECTORY(";
			case xlfFind: return "FIND(";
			case xlfCell: return "CELL(";
			case xlfIserr: return "ISERR(";
			case xlfIstext: return "ISTEXT(";
			case xlfIsnumber: return "ISNUMBER(";
			case xlfIsblank: return "ISBLANK(";
			case xlfT: return "T(";
			case xlfN: return "N(";
			case xlfFopen: return "FOPEN(";
			case xlfFclose: return "FCLOSE(";
			case xlfFsize: return "SIZE(";
			case xlfFreadln: return "FREADLN(";
			case xlfFread: return "FREAD(";
			case xlfFwriteln: return "FWRITELN(";
			case xlfFwrite: return "FWRITE(";
			case xlfFpos: return "FPOS(";
			case xlfDatevalue: return "DATEVALUE(";
			case xlfTimevalue: return "TIMEVALUE(";
			case xlfSln: return "SLN(";
			case xlfSyd: return "SYD(";
			case xlfDdb: return "DDB(";
			case xlfGetDef: return "GETDEF(";
			case xlfReftext: return "REFTEXT(";
			case xlfTextref: return "TEXTREF(";
			case XLF_INDIRECT: return "INDIRECT(";
			case xlfRegister: return "REGISTER(";
			case xlfCall: return "CALL(";
			case xlfAddBar: return "ADDBAR(";
			case xlfAddMenu: return "ADDMENU(";
			case xlfAddCommand: return "ADDCOMMAND(";
			case xlfEnableCommand: return "ENABLECOMMAND(";
			case xlfCheckCommand: return "CHECKCOMMAND(";
			case xlfRenameCommand: return "RENAMECOMMAND(";
			case xlfShowBar: return "SHOWBAR(";
			case xlfDeleteMenu: return "DELETEMENU(";
			case xlfDeleteCommand: return "DELETECOMMAND(";
			case xlfGetChartItem: return "CHARTITEM(";
			case xlfDialogBox: return "DIALOGBOX(";
			case xlfClean: return "CLEAN(";
			case xlfMdeterm: return "MDETERM(";
			case xlfMinverse: return "MINVERSE(";
			case xlfMmult: return "MMULT(";
			case xlfFiles: return "FILES(";
			case xlfIpmt: return "IPMT(";
			case xlfPpmt: return "PPMT(";
			case xlfCounta: return "COUNTA(";
			case xlfCancelKey: return "CANCELKEY(";
			case xlfInitiate: return "INITIATE(";
			case xlfRequest: return "REQUEST(";
			case xlfPoke: return "POKE(";
			case xlfExecute: return "EXECUTE(";
			case xlfTerminate: return "TERMINATE(";
			case xlfRestart: return "RESTART(";
			case xlfHelp: return "HELP(";
			case xlfGetBar: return "GETBAR(";
			case xlfProduct: return "PRODUCT(";
			case xlfFact: return "FACT(";
			case xlfGetCell: return "GETCELL(";
			case xlfGetWorkspace: return "GETWORKSPACE(";
			case xlfGetWindow: return "GETWINDOW(";
			case xlfGetDocument: return "GETDOCUMENT(";
			case xlfIsnontext: return "ISNONTEXT(";
			case xlfGetNote: return "GETNOTE(";
			case xlfNote: return "NOTE(";
			case xlfStdevp: return "STDEVP(";
			case xlfVarp: return "VARP(";
			case xlfTrunc: return "TRUNC(";
			case xlfIslogical: return "ISLOGICAL(";
			case xlfDeleteBar: return "DELETEBAR(";
			case xlfUnregister: return "UNREGISTER(";
			case xlfUsdollar: return "USDOLLAR(";
			case xlfFindb: return "FINDB(";
			case xlfSearchb: return "SEARCHB(";
			case xlfReplaceb: return "REPLACEB(";
			case xlfLeftb: return "LEFTB(";
			case xlfRightb: return "RIGHTB(";
			case xlfMidb: return "MIDB(";
			case xlfLenb: return "LENB(";
			case xlfRoundup: return "ROUNDUP(";
			case xlfRounddown: return "ROUNDDOWN(";
			case xlfAsc: return "ASC(";
			case xlfDbcs: return "DBCS(";
			case xlfRank: return "RANK(";
			case xlfAddress: return "ADDRESS(";
			case xlfDays360: return "DAYS360(";
			case xlfToday: return "TODAY(";
			case xlfVdb: return "VDB(";
			case xlfMedian: return "MEDIAN(";
			case xlfSumproduct: return "SUMPRODUCT(";
			case xlfSinh: return "SINH(";
			case xlfCosh: return "COSH(";
			case xlfTanh: return "TANH(";
			case xlfAsinh: return "ASINH(";
			case xlfAcosh: return "ACOSH(";
			case xlfAtanh: return "ATANH(";
			case xlfCreateObject: return "CREATEOBJECT(";
			case xlfVolatile: return "VOLATILE(";
			case xlfLastError: return "LASTERROR(";
			case xlfCustomUndo: return "CUSTOMUNDO(";
			case xlfCustomRepeat: return "CUSTOMREPEAT(";
			case xlfFormulaConvert: return "FORMULACONVERT(";
			case xlfGetLinkInfo: return "GETLINKINFO(";
			case xlfTextBox: return "TEXTBOX(";
			case xlfInfo: return "INFO(";
			case xlfGroup: return "GROUP(";
			case xlfGetObject: return "GETOBJECT(";
			case xlfDb: return "DB(";
			case xlfPause: return "PAUSE(";
			case xlfResume: return "RESUME(";
			case xlfFrequency: return "FREQUENCY(";
			case xlfAddToolbar: return "ADDTOOLBAR(";
			case xlfDeleteToolbar: return "DELETETOOLBAR(";
			case xlfResetToolbar: return "RESETTOOLBAR(";
			case xlfEvaluate: return "EVALUATE(";
			case xlfGetToolbar: return "GETTOOLBAR(";
			case xlfGetTool: return "GETTOOL(";
			case xlfSpellingCheck: return "SPELLINGCHECK(";
			case xlfErrorType: return "ERROR.TYPE(";
			case xlfAppTitle: return "APPTITLE(";
			case xlfWindowTitle: return "WINDOWTITLE(";
			case xlfSaveToolbar: return "SAVETOOLBAR(";
			case xlfEnableTool: return "ENABLETOOL(";
			case xlfPressTool: return "PRESSTOOL(";
			case xlfRegisterId: return "REGISTERID(";
			case xlfGetWorkbook: return "GETWORKBOOK(";
			case xlfAvedev: return "AVEDEV(";
			case xlfBetadist: return "BETADIST(";
			case xlfGammaln: return "GAMMALN(";
			case xlfBetainv: return "BETAINV(";
			case xlfBinomdist: return "BINOMDIST(";
			case xlfChidist: return "CHIDIST(";
			case xlfChiinv: return "CHIINV(";
			case xlfCombin: return "COMBIN(";
			case xlfConfidence: return "CONFIDENCE(";
			case xlfCritbinom: return "CRITBINOM(";
			case xlfEven: return "EVEN(";
			case xlfExpondist: return "EXPONDIST(";
			case xlfFdist: return "FDIST(";
			case xlfFinv: return "FINV(";
			case xlfFisher: return "FISHER(";
			case xlfFisherinv: return "FISHERINV(";
			case xlfFloor: return "FLOOR(";
			case xlfGammadist: return "GAMMADIST(";
			case xlfGammainv: return "GAMMAINV(";
			case xlfCeiling: return "CEILING(";
			case xlfHypgeomdist: return "HYPGEOMDIST(";
			case xlfLognormdist: return "LOGNORMDIST(";
			case xlfLoginv: return "LOGINV(";
			case xlfNegbinomdist: return "NEGBINOMDIST(";
			case xlfNormdist: return "NORMDIST(";
			case xlfNormsdist: return "NORMSDIST(";
			case xlfNorminv: return "NORMINV(";
			case xlfNormsinv: return "NORMSINV(";
			case xlfStandardize: return "STANDARDIZE(";
			case xlfOdd: return "ODD(";
			case xlfPermut: return "PERMUT(";
			case xlfPoisson: return "POISSON(";
			case xlfTdist: return "TDIST(";
			case xlfWeibull: return "WEIBULL(";
			case xlfSumxmy2: return "SUMXMY2(";
			case xlfSumx2my2: return "SUMX2MY2(";
			case xlfSumx2py2: return "SUMX2PY2(";
			case xlfChitest: return "CHITEST(";
			case xlfCorrel: return "CORREL(";
			case xlfCovar: return "COVAR(";
			case xlfForecast: return "FORECAST(";
			case xlfFtest: return "FTEST(";
			case xlfIntercept: return "INTERCEPT(";
			case xlfPearson: return "PEARSON(";
			case xlfRsq: return "RSQ(";
			case xlfSteyx: return "STEYX(";
			case xlfSlope: return "SLOPE(";
			case xlfTtest: return "TTEST(";
			case xlfProb: return "PROB(";
			case xlfDevsq: return "DEVSQ(";
			case xlfGeomean: return "GEOMEAN(";
			case xlfHarmean: return "HARMEAN(";
			case xlfSumsq: return "SUMSQ(";
			case xlfKurt: return "KURT(";
			case xlfSkew: return "SKEW(";
			case xlfZtest: return "ZTEST(";
			case xlfLarge: return "LARGE(";
			case xlfSmall: return "SMALL(";
			case xlfQuartile: return "QUARTILE(";
			case xlfPercentile: return "PERCENTILE(";
			case xlfPercentrank: return "PERCENTRANK(";
			case xlfMode: return "MODE(";
			case xlfTrimmean: return "TRIMMEAN(";
			case xlfTinv: return "TINV(";
			case xlfMovieCommand: return "MOVIECOMMAND(";
			case xlfGetMovie: return "GETMOVIE(";
			case xlfConcatenate: return "CONCATENATE(";
			case xlfPower: return "POWER(";
			case xlfPivotAddData: return "PIVOTADDDATA(";
			case xlfGetPivotTable: return "GETPIVOTTABLE(";
			case xlfGetPivotField: return "GETPIVOTFIELD(";
			case xlfGetPivotItem: return "GETPIVOTITEM(";
			case xlfRadians: return "RADIANS(";
			case xlfDegrees: return "DEGREES(";
			case xlfSubtotal: return "SUBTOTAL(";
			case XLF_SUM_IF: return "SUMIF(";
			case xlfCountif: return "COUNTIF(";
			case xlfCountblank: return "COUNTBLANK(";
			case xlfScenarioGet: return "SCENARIOGET(";
			case xlfOptionsListsGet: return "OPTIONSLISTSGET(";
			case xlfIspmt: return "ISPMT(";
			case xlfDatedif: return "DATEDIF(";
			case xlfDatestring: return "DATESTRING(";
			case xlfNumberstring: return "NUMBERSTRING("; 
			case xlfRoman: return "ROMAN("; 
			case xlfOpenDialog: return "OPENDIALOG("; 
			case xlfSaveDialog: return "SAVEDIALOG("; 
			case xlfViewGet: return "VIEWGET("; 
			case xlfGetPivotData: return "GETPIVOTDATA(";
			case xlfHyperlink: return "HYPERLINK("; 
			case xlfPhonetic: return "PHONETIC("; 
			case xlfAverageA: return "AVERAGEA("; 
			case xlfMaxA: return "MAXA("; 
			case xlfMinA: return "MINA("; 
			case xlfStDevPA: return "STDEVPA("; 
			case xlfVarPA: return "VARPA("; 
			case xlfStDevA: return "STDEVA("; 
			case xlfVarA: return "VARA("; 
			// ADD-IN FORMULAS
			// Financial Formulas AddIns
			case xlfAccrintm: return "ACCRINTM(";			
			case xlfAccrint: return "ACCRINT(";
			case xlfCoupDayBS: return "COUPDAYBS(";
			case xlfCoupDays: return "COUPDAYS(";
			case xlfCoupDaysNC: return "COUPDAYSNC(";
			case xlfCumIPmt: return "CUMIPMT(";
			case xlfCumPrinc: return "CUMPRINC(";
			case xlfCoupNCD: return "COUPNCD(";
			case xlfCoupPCD: return "COUPPCD(";
			case xlfCoupNUM: return "COUPNUM(";
			case xlfDollarDE: return "DOLLARDE(";
			case xlfDollarFR: return "DOLLARFR(";
			case xlfEffect: return "EFFECT(";
			case xlfINTRATE: return "INTRATE(";
			case xlfXIRR: return "XIRR(";
			case xlfXNPV: return "XNPV(";
			case xlfYIELD: return "YIELD(";
			case xlfPRICE: return "PRICE(";
			case xlfPRICEDISC: return "PRICEDISC(";
			case xlfDISC: return "DISC(";
			case xlfPRICEMAT: return "PRICEMAT(";
			case xlfDURATION: return "DURATION(";
			case xlfMDURATION: return "MDURATION(";
			case xlfTBillEq: return "TBILLEQ(";
			case xlfTBillPrice: return "TBILLPRICE(";
			case xlfTBillYield: return "TBILLYIELD(";
			case xlfYieldDisc: return "YIELDDISC(";
			case xlfYieldMat: return "YIELDMAT(";
			case xlfFVSchedule: return "FVSCHEDULE(";
			case xlfAmorlinc: return "AMORLINC(";
			case xlfAmordegrc: return "AMORDEGRC(";
			case xlfOddFPrice: return "ODDFPRICE(";
			case xlfOddFYield: return "ODDFYIELD(";
			case xlfOddLPrice: return "ODDLPRICE(";
			case xlfOddLYield: return "ODDLYIELD(";
			case xlfNOMINAL: return "NOMINAL(";
			case xlfRECEIVED: return "RECEIVED(";
			// Engineering Formulas AddIns
			case xlfBIN2DEC: 	return "BIN2DEC(";
			case xlfBIN2HEX: 	return "BIN2HEX(";
			case xlfBIN2OCT: 	return "BIN2OCT(";
			case xlfDEC2BIN: 	return "DEC2BIN(";
			case xlfDEC2HEX: 	return "DEC2HEX(";
			case xlfDEC2OCT: 	return "DEC2OCT(";
			case xlfHEX2BIN: 	return "HEX2BIN(";
			case xlfHEX2DEC: 	return "HEX2DEC(";
			case xlfHEX2OCT: 	return "HEX2OCT(";
			case xlfOCT2BIN: 	return "OCT2BIN(";
			case xlfOCT2DEC: 	return "OCT2DEC(";
			case xlfOCT2HEX: 	return "OCT2HEX(";
			case xlfCOMPLEX: 	return "COMPLEX(";
			case xlfGESTEP:  	return "GESTEP(";
			case xlfDELTA:	 	return "DELTA(";
			case xlfIMAGINARY: 	return "IMAGINARY(";
			case xlfIMREAL:		return "IMREAL(";
			case xlfIMARGUMENT: return "IMARGUMENT(";
			case xlfIMABS:		return "IMABS(";
			case xlfIMDIV:		return "IMDIV(";
			case xlfIMCONJUGATE: return "IMCONJUGATE(";
			case xlfIMCOS:		return "IMCOS(";
			case xlfIMSIN:		return "IMSIN(";
			case xlfIMEXP:		return "IMEXP(";
			case xlfIMPOWER:	return "IMPOWER(";
			case xlfIMSQRT:		return "IMSQRT(";
			case xlfIMSUB:		return "IMSUB(";
			case xlfIMSUM:		return "IMSUM(";
			case xlfIMPRODUCT:	return "IMPRODUCT(";
			case xlfIMLN:		return "IMLN(";
			case xlfIMLOG10:	return "IMLOG10(";
			case xlfIMLOG2:		return "IMLOG2(";
			case xlfCONVERT:	return "CONVERT(";
			case xlfDOUBLEFACT:  return "FACTDOUBLE(";
			case xlfGCD: 		return "GCD(";
			case xlfLCM:  		return "LCM(";
			case xlfMROUND: 	return "MROUND(";
			case xlfMULTINOMIAL:	return "MULTINOMIAL("; 
			case xlfQUOTIENT: 	return "QUOTIENT(";
			case xlfRANDBETWEEN: return "RANDBETWEEN(";
			case xlfSERIESSUM: 	return "SERIESSUM(";
			case xlfSQRTPI: 	return "SQRTPI(";
			case xlfERF:		return "ERF(";
			// information Add-ins
			case xlfISEVEN:		return "ISEVEN(";
			case xlfISODD:		return "ISODD(";
			// Date/Time Add-in Formulas
			case xlfNETWORKDAYS:	return "NETWORKDAYS(";
			case xlfEDATE:		return "EDATE(";
			case xlfEOMONTH:	return "EOMONTH(";
			case xlfWEEKNUM:	return "WEEKNUM(";
			case xlfWORKDAY:	return "WORKDAY(";
			case xlfYEARFRAC:	return "YEARFRAC(";
			// Statistical
			case xlfAVERAGEIF:   return "AVERAGEIF(";
			case xlfAVERAGEIFS:   return "AVERAGEIFS(";
			case xlfCOUNTIFS:   return "COUNTIFS(";
			// Logical
			case xlfIFERROR:	return "IFERROR(";
			// Math
			case xlfSUMIFS:		return "SUMIFS(";
        }
		return "";
    }
