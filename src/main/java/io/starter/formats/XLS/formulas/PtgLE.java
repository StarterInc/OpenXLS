...
public class PtgLE extends GenericPtg implements Ptg
{
	...
	*/
	...
	public boolean getIsOperator(){return true;}
	public boolean getIsPrimitiveOperator(){return true;}
	public boolean getIsBinaryOperator(){return true;}
		...
		try{
        	...
        	if (!o[0].getClass().isArray()) {
	    	   ...
	    	   if (o[0] instanceof Double && o[1] instanceof Double) {
	    		   ...
	    		   if (Formula.isErrorValue(o[0].toString())) return new PtgErr(PtgErr.convertStringToLookupByte(o[0].toString()));
	    		   if (Formula.isErrorValue(o[1].toString())) return new PtgErr(PtgErr.convertStringToLookupByte(o[1].toString()));
