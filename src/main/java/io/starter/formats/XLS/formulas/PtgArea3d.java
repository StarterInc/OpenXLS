...
public class PtgArea3d extends PtgArea implements Ptg, IxtiListener{
    ...
    */
    ...
    public boolean contains(CellHandle ch){
    	...
    	getSheetName();
        if(!chsheet.equalsIgnoreCase(sheetname))return false;
...
//				 TODO: check rc sanity here
				...
				} catch (NullPointerException ne) { // can happens when Name record is being init'd and sheet records are not set yet
					return null;
				}
