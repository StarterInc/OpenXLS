...
// determine behavior
    public boolean getIsOperator(){return false;}
    public boolean getIsBinaryOperator(){return false;}
    public boolean getIsUnaryOperator(){return false;}
	public boolean getIsStandAloneOperator(){return false;}
    public boolean getIsPrimitiveOperator(){return false;}
    public boolean getIsOperand(){return false;}
    public boolean getIsFunction(){return false;}
    public boolean getIsControl(){return false;}
    public boolean getIsArray(){return false;}
	public boolean getIsReference(){return false;}
...
//	                    	part= "\"" + part + "\"";
    ...
    */
    ...
    public byte getOpcode(){return ptgId;}
    ...
    */
    ...
    public String getLocation() throws FormulaNotFoundException{return null;}
    public int[] getIntLocation() throws FormulaNotFoundException{return null;}
    
    // Parent Rec is the BiffRec record referenced by Operand Ptgs
    protected XLSRecord parent_rec;
    public void setParentRec(XLSRecord f){parent_rec = f;}
    public XLSRecord getParentRec(){return parent_rec;}
    ...
    */
    ...
    public int readRow(byte b0, byte b1) {
    	if ((parent_rec!=null && !parent_rec.getWorkBook().getIsExcel2007())) {
        	int rw= io.starter.toolkit.ByteTools.readInt(b0, b1, (byte)0, (byte)0);
