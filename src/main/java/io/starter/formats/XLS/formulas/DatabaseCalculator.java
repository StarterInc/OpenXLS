...
class DB {
	...
	public int getNCols() { return colHeaders.length; }
	public int getNRows() { return rows.length; }		
...
class Criteria extends DB {
	public Criteria(int nCols, int nRows) { super(nCols, nRows); }
	...
	private List getCriteria(String field){
		if(true) //criteriaCache==null)
			...
			if(criteriaCache.get(field)!=null)
