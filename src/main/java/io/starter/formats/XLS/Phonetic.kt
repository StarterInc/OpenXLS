 ...
 *
 * **Unknown Record possibly MSO related: MS Office (EFh)**<br></br>
 *
 *
 ...
 * @see MSODrawing
 ** */
class Phonetic : io.starter.formats.XLS.XLSRecord() {
    var PROTOTYPE_BYTES = byteArrayOf(0, 0, 55, 0, 0, 0)
    ...
    companion object {
         ...
         *
         */
        private val serialVersionUID = -3464806666220926523L
    }
