...
//if (cfdbdb!=cfdbTot)
	//Logger.logWarn("SXDB: all cache items are not being used");
		...
		if (cchWho > 0) {
            ...
            }catch(UnsupportedEncodingException e){Logger.logInfo("SxDB.init: " + e);}
		}
    }
...
//		System.arraycopy( ByteTools.shortToLEBytes(crdbUsed), 0, this.getData(), 14, 2);
    ...
    * @return
    */
   public int getNCacheRecords() { return crdbdb; }
    ...
    * @return
    */
	public short getStreamID() { return idstm; }
	 ...
	 */ 
	public int getNCacheFields() { return cfdbdb; }
}