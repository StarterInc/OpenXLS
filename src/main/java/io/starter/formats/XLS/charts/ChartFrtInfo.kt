 ...
 * <br></br>In a file written by Excel 2000 or later, this record appears before the end of CHART
 * record block and before any other FRT in the Chart record stream.
 * <br></br>In a file written by Excel 97, this record may be missing or will appear after
 ...
 */
class ChartFrtInfo : GenericChartObject(), ChartObject {

    private val PROTOTYPE_BYTES = byteArrayOf(80, 8, 0, 0, 10, 10, 3, 0, 80, 8, 90, 8, 97, 8, 97, 8, 106, 8, 107, 8)
    ...
    companion object {
         ...
         * serialVersionUID
         */
        private val serialVersionUID = 7722730813154117198L

        val prototype: XLSRecord?
            get() {
                val cri = ChartFrtInfo()
                cri.opcode = XLSConstants.CHARTFRTINFO
                cri.data = cri.PROTOTYPE_BYTES
                cri.init()
                return cri
            }
    }
