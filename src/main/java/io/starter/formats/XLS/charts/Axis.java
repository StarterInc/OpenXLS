...
import io.starter.formats.XLS.Format;
...
public class Axis extends GenericChartObject implements ChartObject {
	...
	*/
    ...
    public short getAxis() { return wType; }
...
//        	a.setAxis(XAXIS);
     ...
     * @param td
     */
    public void setTd(TextDisp td) { linkedtd= td; }
     ...
     * @param a
     */
    public void setAP(AxisParent a) { ap= a; }
     ...
     * @return
     */
    public io.starter.formats.XLS.Font getLabelFont() {
       	try {
     ...
     * @return JSONObject 
     */
    public JSONObject getJSON(io.starter.OpenXLS.WorkBookHandle wbh, int chartType, double yMax, double yMin, int nSeries) {
...
//Logger.logInfo("Setting option: " + op + "=" + val);
     ...
     * @return JSONObject 
     */
    public JSONObject getMinMaxJSON(io.starter.OpenXLS.WorkBookHandle wbh, int chartType, double yMax, double yMin, int nSeries) {
		JSONObject axisJSON= new JSONObject();
		JSONObject axisOptions= new JSONObject();
		try {
	    	for (int i= 0; i < chartArr.size(); i++) {
     ...
     * @return
     */
    public io.starter.formats.OOXML.Title getOOXMLTitle() { 
    	return ttl; }
...
// TODO: date ax specifics		             
    ...
    public String getOOXML(int type, String id, String crossId) {
    	...
    	// axis main element
     	axisooxml.append("<c:" + axis + ">");		axisooxml.append("\r\n");
     	// axId - required
    	axisooxml.append("<c:axId val=\"" + id + "\"/>");		axisooxml.append("\r\n");
    	// scaling - required
    	...
    	if (this.getOption("axPos")!=null) { 
    		axisooxml.append("<c:axPos val=\"" + this.getOption("axPos") + "\"/>"); axisooxml.append("\r\n"); }
    	else {// it's required
     	...
     	if (this.getOOXMLTitle()!=null) axisooxml.append(this.getOOXMLTitle().getOOXML());
     		...
     		if (!this.getTitle().equals("")) {
	     		io.starter.formats.OOXML.Title ttl= new io.starter.formats.OOXML.Title(this.getTitle());
	     		if (type==0)
...
*/
		...
		// crossesAx
    	axisooxml.append("<c:crossAx val=\"" + crossId + "\"/>");	axisooxml.append("\r\n"); // crosses axis ...
    	// crosses -- autoZero, max, min
    	if (this.getOption("crosses")!=null)
    			axisooxml.append("<c:crosses val=\"" + this.getOption("crosses") + "\"/>");			axisooxml.append("\r\n");// where axis crosses it's perpendicular axis
    	if (axis.equals("catAx") || axis.equals("serAx")) {
    		// auto
...
// TODO: dispUnit ************************************
    ...
    public String getSVG(ChartAxes ca, java.util.Map<String, Double> chartMetrics, Object[] categories) {
    	...
    	if (charttype==ChartConstants.BARCHART) return getSVGBARCHART(ca, titlefontSVG, labelfontSVG, showMinorTickMarks, showMajorTickMarks, chartMetrics, categories);
    	if (charttype==ChartConstants.RADARCHART) return getSVGRADARCHART(ca, titlefontSVG, labelfontSVG, chartMetrics, categories);
	...
	private String drawXAxisSVG(ChartAxes ca, String titlefontSVG, String labelfontSVG, boolean showMinorTickMarks, boolean showMajorTickMarks, java.util.Map<String, Double> chartMetrics, Object[] categories) {
		...
		if (labelRot!=0) {
			...
			io.starter.formats.XLS.Font lf= this.getLabelFont();
			try { 
