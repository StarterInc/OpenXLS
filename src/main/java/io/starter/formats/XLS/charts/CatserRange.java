...
public class CatserRange extends GenericChartObject implements ChartObject {
	...
	*/
    ...
    // get/set methods
    public int getCatCross() { return catCross; }
    public int getCatLabel() { return catLabel; }
    public int getCatMark() { return catMark; }
    public boolean getCrossBetween() { return fBetween; }
    public boolean getCrossMax() { return fMaxCross; }
    public void setCatCross(int c) { catCross= (short) c; updateRecord(); }
    public void setCatLabel(int c) { catLabel= (short) c; updateRecord(); }
    public void setCatMark(int c) { catMark= (short) c; updateRecord(); }
    public void setCrossBetween(boolean b) { fBetween= b; grbit= ByteTools.updateGrBit(grbit, fBetween, 0);  updateRecord(); }
    public void setCrossMax(boolean b) { fMaxCross= b; grbit= ByteTools.updateGrBit(grbit, fMaxCross, 1);  updateRecord(); }
