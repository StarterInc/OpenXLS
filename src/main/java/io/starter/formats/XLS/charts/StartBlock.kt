 ...
 */
class StartBlock : GenericChartObject(), ChartObject {
    internal var iObjectKind: Short = 0

    private val PROTOTYPE_BYTES = byteArrayOf(82, 8, 0, 0, 13, 0, 0, 0, 0, 0, 0, 0)
    ...
    companion object {
         ...
         * serialVersionUID
         */
        private val serialVersionUID = 1895593244077899106L
        val CHART = 13
        val AXIS = 0
        val CHARTFORMAT = 5
        ...
        val prototype: XLSRecord?
            get() {
                val sb = StartBlock()
                sb.opcode = XLSConstants.STARTBLOCK
