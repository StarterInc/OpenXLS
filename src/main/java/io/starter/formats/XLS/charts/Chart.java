    ...
    public List assembleChartRecords() {
        ...
        if (dirtyflag) {
        	for (int i= 0; i < nCharts; i++) {        
        		chartseries.updateSeriesMappings(((ChartType)chartgroup.get(i)).getSeriesList(), i);	// if has multiple or overlay charts, update series mappings
        	}
	...
	*/ 
	public byte[] getChartBytes(){        
		...
		try{
			...
			b = baos.toByteArray();
		}catch(IOException e){Logger.logErr(e);}
		return b;
	}   
	...
	public void setDimensions(Dimensions d) { dimensions= d; }
...
*/    	    	
     ...
     */
     public boolean isThreeD() { return isThreeD(0); }  
    /**
     * 
     * @return truth of "Chart is Three-D"
     * @param nChart 0=default, 1-9= overlay charts
     */
      ...
      */
     public boolean isStacked() { return isStacked(0); }
     /**
      * @return truth of "Chart is Stacked"
     * @param nChart 0=default, 1-9= overlay charts
      */
      ...
      * @return
      */
     public boolean is100PercentStacked() { return is100PercentStacked(0); }
     /**
      * return truth of "Chart is 100% Stacked"
     * @param nChart 0=default, 1-9= overlay charts
      * @return
      ...
      */
    public boolean isClustered() { return isClustered(0); }
     /**
      * @return truth of "Chart is Clustered"  (Bar/Col only)
     * @param nChart 0=default, 1-9= overlay charts
      */
	 ...
	 * 
	 * @param op
	 *            String option e.g. Shadow or Percentage
	 ...
	 * @return String XML
	 */
	public String getThreeDXML() { return getThreeDXML(0); }
	/**
	 * return ThreeD settings for this chart in XML form
     * @param nChart 0=default, 1-9= overlay charts
	 * @return String XML
	 ...
	 * @return
	 */
	public ThreeD initThreeD() { return initThreeD(0, this.getChartType(0)); }
	/**
	 * returns the 3d record of the desired chart
     * @param nChart 0=default, 1-9= overlay charts
	...
	public HashMap getMetrics(WorkBookHandle wbh) {
		if (metricsDirty) {
			try {
				...
				// Chart title offset
				io.starter.formats.XLS.Font titlefont= this.getTitleFont();
