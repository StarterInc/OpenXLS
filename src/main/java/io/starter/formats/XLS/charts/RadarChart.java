...
//		radar = (Radar) charttype;
	 ...
	 * 
	 * @param chartMetrics
	 *            maps chart coords in pixels x, y, w, h, canvasw, canvash, min,
	 *            max
	 * @param axisMetrics
	 *            maps specific axis options such as xAxisReversed, xPattern ...
	 * @param categories
	 * @param series
	 *            arraylist of double[] series values
	 * @param seriescolors
	 *            int[] of series or bar colors color ints
	 * @return String svg
	 */
	...
	public StringBuffer getOOXML(String catAxisId, String valAxisId,String serAxisId) {
		...
		cooxml.append("<c:axId val=\"" + catAxisId + "\"/>");   cooxml.append("\r\n");
		cooxml.append("<c:axId val=\"" + valAxisId + "\"/>");   cooxml.append("\r\n");

		cooxml.append("</c:radarChart>");  cooxml.append("\r\n");
		return cooxml;
	}
}
