...
public class Pie extends GenericChartObject implements ChartObject {
	...
	*/
     ...
     * @return
     */
    public int getDoughnutSize() { return pcDonut; }
     ...
     * @return
     */
    public int getAnStart() { return anStart; }
    ...
    public boolean hasShadow() { return fHasShadow; }
    public boolean showLdrLines() { return fShowLdrLines; }
    ...
    public short getDonutPercentage() { return pcDonut; }
