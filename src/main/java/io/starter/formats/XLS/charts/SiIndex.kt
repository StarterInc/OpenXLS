 ...
 */
class SiIndex : GenericChartObject(), ChartObject {
    internal var type: Short = 0

    override fun init() {
        super.init()
        type = ByteTools.readShort(this.data!![0].toInt(), this.data!![1].toInt())
    }
    ...
    companion object {
         ...
         * serialVersionUID
         */
        private val serialVersionUID = -6810089722566956477L
    }
}
