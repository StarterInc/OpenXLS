...
import io.starter.formats.XLS.Dimensions;
...
public class OOXMLChart extends Chart {
    ...
    public io.starter.formats.OOXML.Legend ooxmlLegend= null;
	...
	public OOXMLChart(Chart c, WorkBookHandle wbh) {	
	  ...
	  if (c.hasDataLegend()) {
		  ooxmlLegend= io.starter.formats.OOXML.Legend.createLegend(c.getLegend());		
	  }
	  this.wbh= wbh;
	}
     ...
     * @return
     */
    public Title getOOXMLTitle() { return ttl; }
     ...
     */
    public String getEditMovement() { return this.editMovement; }
    ...
    /**
     */
    public String getOOXMLName() { return this.name; }
	...
	public StringBuffer getOOXML(String catAxisId, String valAxisId, String serAxisId) {
    	...
    	try {
    		...
    		// lang
    		cooxml.append("<c:lang val=\"" + this.lang + "\"/>");	cooxml.append("\r\n");
    		// rounded corners
