 ...
 */
class FrtFontList : GenericChartObject(), ChartObject {
    ...
    companion object {
         ...
         * serialVersionUID
         */
        private val serialVersionUID = 5374035624852924277L

        val prototype: XLSRecord?
            get() {
                val ffl = FrtFontList()
                ffl.opcode = XLSConstants.FRTFONTLIST
                ffl.data = ffl.PROTOTYPE_BYTES
                ffl.init()
                return ffl
            }
    }
