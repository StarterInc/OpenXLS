...
import io.starter.formats.OOXML.Ln;
...
public class LineFormat extends GenericChartObject implements ChartObject{
    ...
    */
     ...
     */
    public int getLineStyle() { return lnx; }
...
//    		sppr.setLine(we, clr);
    ...
    public String toString() { return "LineFormat: LinePattern=" + lnx + " Weight=" + we + " Draw Ticks=" + ((grbit & 0x4)==0x4); }
