...
public class MarkerFormat extends GenericChartObject implements ChartObject {
	...
	*/
     ...
     * @return
     */
    public int getMarkerFormat() { return imk; }
    /**
     * set the Marker Format field imk + update the record
     * @param imk
     */
    public void setMarkerFormat(short imk) { this.imk= imk; updateRecord();}
    public String toString() { return "MarkerFormat: imk= " + imk + " grbit=" + grbit; }
