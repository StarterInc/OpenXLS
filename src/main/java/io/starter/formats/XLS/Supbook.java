...
public final class Supbook extends io.starter.formats.XLS.XLSRecord {
        ...
        if (isGlobalRecord())
            ...
            try {
                ...
                if (compression == 0) { //non-unicode
                    ...
                    filename = new String(f, StandardCharsets.UTF_16LE);
                    pos += ln * 2 - 1;
                }
                if (DEBUGLEVEL > 5)
                ...
                for (int i = 0; i < cstab; i++) {
                    ...
                    if (compression == 0) {
                        ...
                        sheetname = new String(f, StandardCharsets.UTF_16LE);
                        pos += ln * 2;
                    }
                    tabs.add(sheetname);
                    if (DEBUGLEVEL > 5)
