...
/* unused: 	public void setBlocks(Block[] myb) {
     ...
     *
     * @see io.starter.formats.XLS.BiffRec#copyFormat(io.starter.formats.XLS.BiffRec)
     */
    ...
    public void addContinue(Continue c) {
        if (continues == null) continues = new ArrayList();
        continues.add(c);
    }
    ...
    public String getCellAddress() {
        ...
        if ((rownum > MAXROWS) || (col < 0)) {
            if (DEBUGLEVEL > -1)
                Logger.logWarn("XLSRecord.getCellAddress() Row/Col info incorrect for Cell:" + ExcelTools.getAlphaVal(col) + rownum);
            return "";
        }
