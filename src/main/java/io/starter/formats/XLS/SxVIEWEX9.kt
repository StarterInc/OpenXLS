 ...
 */
class SxVIEWEX9 : XLSRecord(), XLSConstants {

    private val PROTOTYPE_BYTES = byteArrayOf(0x10, 0x8, /* rt= 0x810 */
            0, 0, /* flags + reserved */
            0, 0, 0, 0, 0x20, 0, 0, 0, 1, 0, /* itblAutoFmt*/
            0, 0, 0    /* chGrand-- cch= 0, encoding= 0 */)
    ...
    companion object {
        ...
        val prototype: XLSRecord?
            get() {
                val sxv = SxVIEWEX9()
                sxv.opcode = XLSConstants.SXVIEWEX9
