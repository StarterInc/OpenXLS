...
public final class Name extends XLSRecord {
    ...
    **/
    private final byte[] FILLER_NAME_BYTES = {0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0};
    ...
    private final byte[] PROTOTYPE_NAME_BYTES = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0};
    ...
    public void init(boolean initExpression) {
        ...
        try {
            ...
            if (DEBUG) Logger.logInfo(this.getName());
            pos += cch;
    ...
    public String getLocation()
        ...
        if (ptga instanceof PtgRefErr3d)        // 20080228 KSC: return Exception rather than null upon Deleted Named Range
            throw new io.starter.formats.XLS.CellNotFoundException("Named Range " + this.getName() + " has been deleted or it's referenced cell is invalid");    // JM - why not return loc? 'Cause it's deleted!!! :) // 20071203 KSC
