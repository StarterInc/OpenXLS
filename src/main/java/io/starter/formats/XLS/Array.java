 ...
 */
public final class Array extends io.starter.formats.XLS.XLSRecord 
{
...
// isValueForCell will DELETE THE CELL if remove/change NOT WHAT WE WANT HERE
		rwFirst= (short) io.starter.toolkit.ByteTools.readInt(this.getByteAt(0),this.getByteAt(1), (byte)0, (byte)0);
        rwLast= (short) io.starter.toolkit.ByteTools.readInt(this.getByteAt(2),this.getByteAt(3), (byte)0, (byte)0);        
...
// isValueForCell will DELETE THE CELL if remove/change NOT WHAT WE WANT HERE
    ...
    boolean isInRange(String addr){
        return io.starter.OpenXLS.ExcelTools.isInRange(addr, rwFirst, rwLast, colFirst, colLast);
    }
	 ...
	 * @return
	 */
	public Stack getExpression() { return expression; }
