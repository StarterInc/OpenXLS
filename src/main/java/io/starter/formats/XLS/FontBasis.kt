 ...
 */
class FontBasis : XLSRecord() {

    var fontIndex: Int
        get() = ByteTools.readShort(this.getData()!![8].toInt(), this.getData()!![9].toInt()).toInt()
        set(id) {
            val b = ByteTools.shortToLEBytes(id.toShort())
            this.getData()[8] = b[0]
            this.getData()[9] = b[1]
        }
    ...
    companion object {
         ...
         * serialVersionUID
         */
        private val serialVersionUID = 6984935185426785077L
    }
