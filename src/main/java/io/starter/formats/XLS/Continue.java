 ...
 */
public final class Continue extends io.starter.formats.XLS.XLSRecord {
    /**
     * serialVersionUID
     */
    ...
    boolean isBigRecContinue() {
        ...
        return this.predecessor.getLength() >= MAXRECLEN;
    }
    ...
    boolean getHasGrbit() {
        ...
        if (DEBUGLEVEL > 1) {
            Logger.logInfo("Grbit pos0: " + (getGrbit() & 0));
            Logger.logInfo("Grbit pos2: " + (getGrbit() & 4));
            Logger.logInfo("Grbit pos3: " + (getGrbit() & 8));
        }
