...
public final class ExpressionParser implements java.io.Serializable  {
    ...
    */
    ...
    public static Stack parseExpression(byte[] function, XLSRecord rec, int expressionLen){
        ...
        if(expressionLen > function.length)expressionLen = function.length; // deal with out of spec formulas (testJapanese:Open25.xls) -jm
        ...
        for (int i = 0; i <expressionLen;){
            ...
            switch (ptg){
                ...
                case ptgExp:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgExp Located");
                    if (i == 0){// MUST BE THE ONLY PTG in the formula expression
                        PtgExp px = new PtgExp();
                        ptgLen = px.getLength();
                        byte[] b = new byte[ptgLen];
                        if((ptgLen+i) <= function.length) System.arraycopy(function, (i), b, 0, ptgLen);
                        px.setParentRec(p);
                        px.init(b);
                        stack.push(px);
                        break;
				...
				case ptgMemAreaA:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgMemAreaA Located" + function[i]);
					x = i;
				...
				case ptgMemAreaN:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgMemAreaN Located" + function[i]);
				...
				case ptgMemAreaNV:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgMemAreaNV Located" + function[i]);
					x = i;
					x += 5; // move past the opcode & reserved to the cce
					ptgLen = ByteTools.readShort(function[x], function[x+1]); // this is the cce
					ptgLen += 7; // include the PtgId, cce, & reserv;
...
//				ptgMemArea also varies in length...							
				case ptgMemArea:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgMemArea Located" + function[i]);
					ptgLen= 7;
			   ...
			   case ptgMemFunc:
				   if(DEBUGLEVEL > 5)Logger.logInfo("ptgMemFunc Located");
                ...
                case ptgInt:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgInt Located");
                ...
                case ptgErr:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgErr Located");
                ...
                case ptgNum:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgNum Located");
                ...
                case ptgBool:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgBool Located");
                ...
                case ptgName:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgName Located");
					...
					if(chk<function.length){
						if(function[i+ptgLen]==0x0){
							if(DEBUGLEVEL > 1)Logger.logWarn("Undocumented Name Record mystery byte encountered in Formula: ");
							i++;
						}	
					}
                    break;
				...
				case ptgNameX:
					if(DEBUGLEVEL > 1)Logger.logInfo("ptgNameX Located");
				    if(DEBUGLEVEL > 0)Logger.logWarn("referencing external spreadsheets unsupported.");
                ...
                case ptgRef:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgRef Located ");
				...
				case ptgArray:
					hasArrays = true;
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgArray Located ");
                ...
                case ptgRefN:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgRefN Located ");
                ...
                case ptgArea:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgArea Located ");
                ...
                case ptgArea3d:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgArea3d Located ");
                ...
                case ptgAreaN:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgAreaN Located ");
				...
				case ptgAreaErr3d:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgAreaErr3d Located");
				...
				case ptgRefErr3d:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgRefErr3d Located");
                ...
                case ptgMemErr:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgMemErr Located");
                ...
                case ptgRefErr:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgRefErr Located");
				...
				case ptgEndSheet:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgEndSheet Located");
                ...
                case ptgRef3d:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgRef3d Located");
                ...
                case ptgAtr:
                    ...
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgAtr Located");
                ...
                case ptgFunc:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgFunc Located");
                 ...
                 case ptgFuncVar:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgFuncVar Located");
...
/**/                    	
 ...
 /**/
                ...
                case ptgAdd:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgAdd Located");
                ...
                case ptgMissArg:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgMissArg Located");
                ...
                case ptgSub:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgSub Located");
                ...
                case ptgMlt:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgMlt Located");
                ...
                case ptgDiv:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgDiv Located");
				...
				case ptgUPlus:
					if(DEBUGLEVEL > 5)Logger.logInfo("PtgUPlus Located");
				...
				case ptgUMinus:
					if(DEBUGLEVEL > 5)Logger.logInfo("PtgUminus Located");
				...
				case ptgPercent:
					if(DEBUGLEVEL > 5)Logger.logInfo("ptgPercent Located");
                ...
                case ptgPower:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgPower Located");
                ...
                case ptgConcat:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgConcat Located");
                ...
                case ptgLT:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgLT Located");
                    PtgLT plt = new PtgLT();
                ...
                case ptgLE:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgLE Located");
                    PtgLE ple = new PtgLE();
                ...
                case ptgEQ:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgEQ Located");
                    PtgEQ peq = new PtgEQ();
                ...
                case ptgGE:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgGE Located");
                    PtgGE pge = new PtgGE();
                ...
                case ptgGT:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgGT Located");
                    PtgGT pgt = new PtgGT();
                ...
                case ptgNE:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgNE Located");
                    PtgNE pne = new PtgNE();
                ...
                case ptgIsect:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgIsect Located");
                ...
                case ptgUnion:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgUnion Located");
                ...
                case ptgRange:
                    if(DEBUGLEVEL > 5)Logger.logInfo("ptgRange Located");
                ...
                case ptgParen:
                    if(DEBUGLEVEL > 5)Logger.logInfo("PtgParens Located");
                ...
                default:
                    ...
                    b = new byte[ptgLen];
					if(DEBUGLEVEL > 0)Logger.logWarn("Unsupported Formula Function: 0x"+ Integer.toHexString(ptg) + " length: " + ptgLen); 
                    System.arraycopy(function, i, b, 0, ptgLen);
                    pmy.init(b);
                    pmy.setParentRec(p);
                    stack.push(pmy);
        ...
        if (hasArrays && rec instanceof Formula){	// Array Recs handle extra data differently
        	...
        	for (int i=0;i<arrayLocs.size();i++){
				...
				}catch(Exception e){//TODO: this needs to be caught due to "name" records being parsed incorrectly.  The problem has to do with the lenght of the name record not including the extra 7 bytes of space.  Temporary fix for infoteria
					if (DEBUGLEVEL > 0)Logger.logInfo("ExpressionParser.parseExpression: Array: " + e);
				}
        	}
        ...
        if(DEBUGLEVEL > 5)Logger.logInfo("finished formula");
        return stack;
    ...
    */
    public static List getPtgsByLocation(String loc, Stack expression)
        throws FormulaNotFoundException{
        List lv = new Vector();
        for (int i = 0; i< expression.size(); i++){
            Object o = expression.elementAt(i);
            if(o == null)throw new FormulaNotFoundException("Couldn't get Ptg at: " + loc);
            if (o instanceof Byte){
                ...
                if(loc.indexOf("!")>-1){ // the sheet is referenced
                	if(lo.indexOf("!")==-1){ // and the ptg does not have sheet referenced
                ...
                if (comp.equalsIgnoreCase(lo)){
	                ...
	                }else if(o instanceof PtgRef3d){// gotta look into the first & last
	                	// already checked
	                }else if(o instanceof PtgArea){// gotta look into the first & last
     ...
     * @throws FormulaNotFoundException
     */
    public static int getExpressionLocByLocation(String loc, Stack expression)
    throws FormulaNotFoundException{
    ...
    for (int i = 0; i< expression.size(); i++){
        ...
        if (o instanceof Byte){
            ...
            if(o instanceof PtgArea){// gotta look into the first & last
                Ptg first = ((PtgArea)o).getFirstPtg();
                Ptg last = ((PtgArea)o).getLastPtg();
                if(first.getLocation().equalsIgnoreCase(loc))return i;
                if(last.getLocation().equalsIgnoreCase(loc))return i;
            }
        }
    }
    return -1;
     ...
     * @throws FormulaNotFoundException
     */
    public static int getExpressionLocByPtg(Ptg ptg, Stack expression)
    throws FormulaNotFoundException{
	    
	    for (int i = 0; i< expression.size(); i++){
	        Object o = expression.elementAt(i);
	        if(o == null)throw new FormulaNotFoundException("Couldn't get Ptg at: " + ptg.toString());
	        if (o instanceof Byte){
	            // do nothing
	        }else if (o instanceof Ptg){
	        	if (((Ptg) o).equals(ptg))
	...
	*/    
	public static Ptg[] getCellRangePtgs(Stack expression)
		throws FormulaNotFoundException{
        Vector ret = new Vector();
		for (int i = 0; i< expression.size(); i++){
			Object o = expression.elementAt(i);
			if(o == null)throw new FormulaNotFoundException("Couldn't get Ptg at: " + i);
			if (o instanceof Byte){
				// do nothing
			}else if (o instanceof Ptg){
				Ptg part = (Ptg) o;
