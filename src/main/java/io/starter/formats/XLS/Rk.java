...
extends XLSCellRecord implements Mulled
{
	...
	*/
	private static final long serialVersionUID = -3027662614434608240L;
        ...
        public void setMyMul(Mul m){mymul = (Mulrk)m;}
        public Mul getMyMul(){return mymul;}
        public void setNoMul(){mymul = null;}
...
// NOTE isFPNumber, isIntNumber was set in translateRk anyways so take out of here        	
        ...
        public double getDblVal(){
            if(isIntNumber)return (double)RKint;
        ...
        public void setStringVal(String s){
            ...
            }catch(java.lang.NumberFormatException f){Logger.logWarn("in Rk "+ s + " is not a number.");}
        }
        
        /**
         * 
         * @see io.starter.formats.XLS.XLSRecord#setFloatVal(float)
         */
        ...
        /**
         * 
         * @see io.starter.formats.XLS.XLSRecord#setIntVal(int)
         */
        ...
        /**
         * 
         * @see io.starter.formats.XLS.XLSRecord#setDoubleVal(double)
         */
    ...
    public int getType(){return rkType;}
