...
import io.starter.formats.XLS.SxAddl.ADDL_CLASSES;
...
<blockquote>((this data item value) * (grand total of grand totals)) / ((row grand total) * (column grand total))</blockquote>
	...
	public void init(){
        ...
        if (cchName!=-1) {
            ...
            }catch(UnsupportedEncodingException e){Logger.logInfo("encoding PivotTable caption name in Sxvd: " + e);}
        }
        if (DEBUGLEVEL > 3) Logger.logInfo("SXDI - isxvdData:" +isxvdData + " iiftab:" + iiftab + " df:" + df + " isxvd:" + isxvd + " isxvi:" + isxvi + " ifmt:" + ifmt + " name:" + name);
	}
	 ...
	 * @return 
	 */
	public short getPivotFieldIndex() { return isxvdData; }
	/**
	 ...
	 * @return
	 */
	public int getDisplayCalculation() { return df; }
	 ...
	 * @return
	 */
	public short getCalculationPivotFieldIndex() { return isxvd; }
	/**
	 * specifies a pivot field index used in calculations as specified by the Display Calculation function
	 * @return
	 */
	 ...
	 * @return
	 */
	public short getCalculationPivotItemIndex() { return isxvi; }
	/**
	 * specifies a pivot item index used in calculations as specified by the Display Calculation function
	 * @return
	 */
	 ...
	 * @return
	 */
	public short getNumberFormat() { return ifmt; }
	/**
