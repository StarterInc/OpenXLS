...
public class TwoCellAnchor implements OOXMLElement {
     ...
     */
    public static int[] convertBoundsFromBIFF8(io.starter.formats.XLS.Boundsheet sheet, short[] bbounds) {
        // note on bounds:
...
//		bounds[5]= (int)(EMU*cw*(bbounds[5]/1024.0));
     ...
     */
    public static short[] convertBoundsToBIFF8(io.starter.formats.XLS.Boundsheet sheet, int[] bounds) {
