...
public class P implements OOXMLElement{
	...
	private static final long serialVersionUID = 6302706683933521698L;
		...
		public String getOOXML() {
	    	...
	    	if (run!=null) ooxml.append(run.getOOXML());	// 20090526 KSC: order of children was wrong (Kaylan/Rajesh chart error)	    	
		...
		public String getTitle() { if (run!=null) return run.getTitle(); return "";}
