...
public class Border implements OOXMLElement{
	...
	public static String getOOXML(Xf xf) {
		...
		if (lineStyles[0]>0)  {
			...
			if (colors[0]>0) ooxml.append("><color rgb=\"" + FormatHandle.colorToHexString(FormatHandle.COLORTABLE[colors[0]]).substring(1) + "\"/></left>");
			else ooxml.append("/>");
		}
		...
		if (lineStyles[1]>0) {
			...
			if (colors[1]>0) ooxml.append("><color rgb=\"" + FormatHandle.colorToHexString(FormatHandle.COLORTABLE[colors[1]]).substring(1) + "\"/></right>");
			else ooxml.append("/>");
		}
		...
		if (lineStyles[2]>0) {
			...
			if (colors[2]>0) ooxml.append("><color rgb=\"" + FormatHandle.colorToHexString(FormatHandle.COLORTABLE[colors[2]]).substring(1) + "\"/></top>");
			else ooxml.append("/>");
		}
		...
		if (lineStyles[3]>0) {
			...
			if (colors[3]>0) ooxml.append("><color rgb=\"" + FormatHandle.colorToHexString(FormatHandle.COLORTABLE[colors[3]]).substring(1) + "\"/></bottom>");
			else ooxml.append("/>");
		}
		...
		if (lineStyles[4]>0) {
			...
			if (colors[4]>0) ooxml.append("><color rgb=\"" + FormatHandle.colorToHexString(FormatHandle.COLORTABLE[colors[4]]).substring(1) + "\"/></diagonal>");
			else ooxml.append("/>");
		}
		ooxml.append("</border>");  
		return ooxml.toString();
	...
	public static String getOOXML(int[] styles, int[] colors) {
		...
		if (styles[3]>0) {
			...
			if (colors[3]>0) ooxml.append("><color rgb=\"" + FormatHandle.colorToHexString(FormatHandle.COLORTABLE[colors[3]]).substring(1) + "\"/></top>");
			else ooxml.append("/>");
		}
		 // diagonal
		if (styles[4]>0) {
