...
implements Cloneable {
	...
	public CellRangeRef (int first_row, int first_col,
	...
	public CellRangeRef (int first_row, int first_col, int last_row,
			int last_col, String first_sheet, String last_sheet) {
	...
	public CellRangeRef (int first_row, int first_col, int last_row, 
			int last_col, WorkSheetHandle first_sheet,
	 ...
	 */
	public static CellRangeRef fromA1 (String reference, WorkBookHandle book)
	...
	public String getFirstSheetName() {
		if (first_sheet != null) return first_sheet.getSheetName();
		else return first_sheet_name;
	}
	...
	public String getLastSheetName() {
		if (last_sheet != null) return last_sheet.getSheetName();
		else return last_sheet_name;
	}
	...
	public boolean isMultiSheet() {
		return (first_sheet != null && last_sheet != null 
					&& first_sheet != last_sheet)
			|| (first_sheet_name != null && last_sheet_name != null
					&& first_sheet_name != last_sheet_name);
	}
	...
	public boolean contains (CellRangeRef range) {
		return this.first_row <= range.first_row
			&& this.last_row  >= range.last_row
			&& this.first_col <= range.first_col
	...
	public boolean equals (Object other) {
		...
		if (other == null || !( other instanceof CellRangeRef )) return false;
	...
	public String toString() {
		...
		return (sheet1 != null ? sheet1
					+ (sheet2 != null && sheet2 != sheet1 ? ":" + sheet2 : "") 
					+ "!" : "")
				+ ExcelTools.formatRange(new int[]{
