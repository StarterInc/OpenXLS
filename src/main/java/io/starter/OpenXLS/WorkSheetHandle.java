...
import io.starter.formats.XLS.Colinfo;
...
import io.starter.formats.XLS.FeatHeadr;
...
import io.starter.formats.XLS.Password;
import io.starter.formats.XLS.ReferenceTracker;
import io.starter.formats.XLS.Row;
import io.starter.formats.XLS.RowNotFoundException;
import io.starter.formats.XLS.SheetProtectionManager;
...
public class WorkSheetHandle implements Handle {
	 ...
	 * @param password
	 *            the password to set if protect is <code>true</code>. ignored when
	 *            protect is <code>false</code>.
	 * @throws WorkBookException
	 *             never. This used to be thrown when unprotecting if the password
	 *             was incorrect.
	 */
	 ...
	 * 
	 * @param password
	 *            the clear text of the password to be applied or null to remove the
	 *            existing password
	 */
	...
	public ColHandle[] getColumns() {
		List columns = new CompatibleVector();
	 ...
	 *                is thrown if there is no existing Cell at the specified
	 *                address.
	 */
	 ...
	 *            whether to attempt to store as a number with a format pattern.
	 * 
	 * 
	 */
	 ...
	 *                is thrown if there is no existing formula at the specified
	 *                address.
	 */
	 ...
	 * @param firstCondition
	 *            = formula string, seeValidationHandle.setFirstCondition
	 * @param secondCondition
	 *            = seeValidationHandle.setSecondCondition, this can be left null
	...
	public void readCSV(BufferedReader input) throws IOException {
		int rws = 0;
		String field_delimiter = System.getProperty("io.starter.OpenXLS.csvdelimiter", ",");
